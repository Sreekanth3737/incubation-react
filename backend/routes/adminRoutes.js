...
const {newApplication,pendingApplication,registeredApplication,allApplication,allApps,viewDetails,blockedApplication,changingStatus}=require('../controller/AdminController')
